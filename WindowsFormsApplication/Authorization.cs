...
namespace WindowsFormsApplication
{
    class Authorization
    {
        ...
        public const UInt32 AUTH_RETVAL_FILE_NOT_EXIST = 1U;/* 用户选择退出按键 */
        public const UInt32 AUTH_RETVAL_FILE_ERROR = 2U;/* 配置文件校验错误 */
        public const UInt32 AUTH_RETVAL_CHECKSUM_ERROR = 3U;/* 用户选择退出按键 */
        public const UInt32 AUTH_RETVAL_COMPARER_ERROR = 4U;/* 用户选择退出按键 */
        public const UInt32 AUTH_RETVAL_NORMAL = 0U;/* 用户选择退出按键 */
        ...
        ****************************************************************************************/
        ...
        public static void encDec_Key_Iv_DefaultValue_Init()
        {
            /****************************************************************************************
                生成系统初始加密解密的默认的密钥
            ****************************************************************************************/
        ...
        public static UInt32 Authorization_Judgment(ref String serialNumOutput, ref String mesgOutput)
        {
            MachineInfo info = MachineInfo.machineInfo();       //获取主机的对象信息
            ...
            ****************************************************************************************/
            ...
            /****************************************************************************************
                将序列号输出到授权界面进行显示
            ****************************************************************************************/
            serialNumOutput = serial_Number_Encrypted;
           ...
           **************************************************************************************************/
            if (!File.Exists("vvs-cfg\\vvsconfig.bin"))
            {
                ...
                //{
                //}
                mesgOutput = "请将序列号联系新誉相关人员获取授权！";
                return AUTH_RETVAL_FILE_NOT_EXIST;
            }
            else
            {
                try
                {
                    ...
                    **************************************************************************************************/
                    if (Read_File_Buffer.Length != 40) /* 固定的二进制文件的长度 */
                    {
                        ...
                        //showSubForm(f111111111111111);
                        //return;
                        mesgOutput = "请勿修改配置文件，请重新授权！";
                        return AUTH_RETVAL_FILE_ERROR;
                    }
                    ...
                    **************************************************************************************************/
                        ...
                        Check_Value[1] != Read_File_Buffer[37])
                    {
                        ...
                        //return;
                        mesgOutput = "请勿修改配置文件，请重新授权！";
                        return AUTH_RETVAL_CHECKSUM_ERROR;
                    }
                    ...
                    for (int i = 0; i < 16; i++)
                    {
                        ...
                        *****************************************************************************************************************************/
                        if (!tmp_Dst[i].Equals(Decrypted_Output[i]))
                        {
                            ...
                            //return;
                            mesgOutput = "请勿修改配置文件，请重新授权！";
                            return AUTH_RETVAL_COMPARER_ERROR;
                        }
                    }
                }
                catch
                ...
                return AUTH_RETVAL_NORMAL; /* 一切正常，返回0 */
            }
        }

        public static void showSubForm_Dialog(Form f)
        {
